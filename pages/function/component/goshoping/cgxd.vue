		...
		<view class="box-content" v-show="ifpage">
			...
			<view v-show="contentShow">
				<u-form class="form-card" labelPosition="left" :model="uFormModel" :rules="uFormRules" ref="uForm">
					...
					<u-form-item label="采购数量" :labelWidth="74" prop="jycgsl" v-show="doingindex>=1">
					...
					<u-form-item label="供货价格" :labelWidth="74" prop="jycgjg" v-show="doingindex>=2">
				...
				<view class="form-card" v-show="doingindex>=4">
